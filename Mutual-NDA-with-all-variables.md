...
<span class="coverpage_link">Party 1</span>

**Party 2**

<span class="coverpage_link">Party 2</span>
...
<span class="coverpage_link">MNDA Modifications</span>

Common Paper Mutual Non-Disclosure Agreement with All Variables [Version 1.0-preimage](https://commonpaper.com/standards/mutual-nda/1.0/) free to use under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
